...
$('#replyModal').on('show.bs.modal', (event) => {
    ...
    var postId = getPostIdElement(button);
...
$(document).on('click', '.post', (event) => {
    ...
    var postId = getPostIdElement(element);
...
function createPostHtml(postData, largeFont = false) {
    ...
    if(postData == null || postData.content == null) {
        // return postData.content = "<div class='notAvailable'>Tweet was deleted</div>";
        return;
    } 
    ...
    if(postData.replyTo && postData.replyTo._id) {
        ...
        if(!postData.replyTo._id) {
            ...
            return alert('Posted_by is not populated');
        }
...
function outputNotificationList(notifications, container) {
    ...
    if(notifications.length == 0) {
        container.append("<span class='noReults'>Nothing to show.</span>");
    }
}
...
function getNotificationText(notification) {
    var userFrom = notification.userFrom;
    console.log(userFrom, userFrom.firstName);

    // if(!userFrom.firstName || !userFrom.lastName) {
    //     return console.log('user from data not populated');
    // }
    ...
    return `<span class='ellepsis'>${text}</span>`;
} 
...
function createChatHtml(chatData) {
    var chatName = getChatName(chatData); // TO DO
    var image = getChatImageElements(chatData); // TO DO
...
function getChatImageElements(chatData) {
    ...
    if(otherChatUsers.length > 1) {
        ...
        chatImage = getUserChatImageElement(otherChatUsers[1]) + chatImage;
    }
